    ...
    Box(contentAlignment = Alignment.Center,modifier = Modifier
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Row(modifier = Modifier
                ...
                Text(text = mainVm.getTime(min) + " : "+  mainVm.getTime(sec),fontSize = 20.sp,fontWeight = FontWeight.Bold,modifier = Modifier
                    .padding(4.dp))
            }
            Button(onClick = { mainVm.changeTimerState() }, modifier = Modifier.padding(0.dp,40.dp,0.dp,0.dp)) {
    ...
    Box(contentAlignment = Alignment.Center,modifier = Modifier
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Row(modifier = Modifier
                ...
                Text(text = "${selectedTime} minute",fontSize = 20.sp,fontWeight = FontWeight.Bold,modifier = Modifier
                    .border(
                        2.dp,
